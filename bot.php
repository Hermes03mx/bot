<?php
    ...
    $gate1 = "https://unascendable-resist.000webhostapp.com/api.php"; /// Your Checker URl with api.php or chk.php
  //$gate2 = "";
if($message == "/start"){
...
*/
    function send_message($chat_id,$message_id, $message){
       ...
       $apiToken = $_ENV['1852214840:AAFCO12Ltu_Dlj4B0nfnGRVMH2HCG-wjXHQ']; ///Bot api token  
